    ...
    <div className="fixed inset-0 bg-background/95 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-card p-8 rounded-lg mx-4 text-center shadow-xl max-w-sm">
        <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <img src="/images/echodeed_electric_logo.png" alt="EchoDeed" className="w-16 h-16 object-contain" onError={(e) => { console.log('Onboarding logo failed to load'); e.currentTarget.style.display = 'none'; }} />
        </div>
